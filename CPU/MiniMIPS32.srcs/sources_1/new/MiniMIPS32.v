...
module MiniMIPS32(
    ...
    id_stage id_stage0(.id_pc_i(id_pc_i), 
        ...
        .id_wa_o(id_wa_o), .id_wreg_o(id_wreg_o), .id_mreg_o(id_mreg_o),
    ...
    idexe_reg idexe_reg0(.cpu_clk_50M(cpu_clk_50M), .cpu_rst_n(cpu_rst_n), 
        ...
        .id_wa(id_wa_o), .id_wreg(id_wreg_o), .id_mreg(id_mreg_o),
        .id_debug_wb_pc(id_debug_wb_pc_o),
        .exe_alutype(exe_alutype_i), .exe_aluop(exe_aluop_i),
        .exe_src1(exe_src1_i), .exe_src2(exe_src2_i), 
        .exe_wa(exe_wa_i), .exe_wreg(exe_wreg_i), .exe_mreg(exe_mreg_i),
    ...
    exe_stage exe_stage0(
        ...
        .exe_wa_i(exe_wa_i), .exe_wreg_i(exe_wreg_i), .exe_mreg_i(exe_mreg_i)
        .exe_debug_wb_pc(exe_debug_wb_pc_i),
        .exe_aluop_o(exe_aluop_o),
        .exe_wa_o(exe_wa_o), .exe_wreg_o(exe_wreg_o), .exe_mreg_o(exe_mreg_o), .exe_wd_o(exe_wd_o),
        .debug_wb_pc(exe_debug_wb_pc_o)
    );
        
    exemem_reg exemem_reg0(.cpu_clk_50M(cpu_clk_50M), .cpu_rst_n(cpu_rst_n),
        .exe_aluop(exe_aluop_o),
        .exe_wa(exe_wa_o), .exe_wreg(exe_wreg_o), .exe_mreg(exe_mreg_o), .exe_wd(exe_wd_o),
        .exe_debug_wb_pc(exe_debug_wb_pc_o),
        .mem_aluop(mem_aluop_i),
        .mem_wa(mem_wa_i), .mem_wreg(mem_wreg_i), .mem_mreg(mem_mreg_i), .mem_wd(mem_wd_i),
        .mem_debug_wb_pc(mem_debug_wb_pc_i)
    );

    mem_stage mem_stage0(.mem_aluop_i(mem_aluop_i),
        .mem_wa_i(mem_wa_i), .mem_wreg_i(mem_wreg_i), .mem_mreg_i(mem_mreg_i), .mem_wd_i(mem_wd_i),
        .mem_debug_wb_pc(mem_debug_wb_pc_i),
    ...
    memwb_reg memwb_reg0(.cpu_clk_50M(cpu_clk_50M), .cpu_rst_n(cpu_rst_n),
        .mem_wa(mem_wa_o), .mem_wreg(mem_wreg_o), .mem_mreg(), .mem_dreg(mem_dreg_o),
